    ...
    namespace NRE {
        namespace Math {
            ...
            constexpr Vector3D<T>::Vector3D(Vector2D<K> const& u, L nZ) : Vector3D(u.getX(), u.getY(), nZ) {
            }
            ...
            template <class T>
            template <class K>
            constexpr void Vector3D<T>::setX(K nX) {
                x = static_cast <T> (nX);
            }

            template <class T>
            template <class K>
            constexpr void Vector3D<T>::setY(K nY) {
                y = static_cast <T> (nY);
            }

            template <class T>
            template <class K>
            constexpr void Vector3D<T>::setZ(K nZ) {
                z = static_cast <T> (nZ);
            }

            template <class T>
            template <class K>
            constexpr void Vector3D<T>::setR(K r) {
                setX(r);
            }

            template <class T>
            template <class K>
            constexpr void Vector3D<T>::setG(K g) {
                setY(g);
            }

            template <class T>
            template <class K>
            constexpr void Vector3D<T>::setB(K b) {
                setZ(b);
            }

            template <class T>
            template <class K, class L, class N>
            constexpr void Vector3D<T>::setCoord(K nX, L nY, N nZ) {
                setX(nX);
                setY(nY);
                setZ(nZ);
            }
            ...
            template <class T>
            template <class K, class L>
            constexpr void Vector3D<T>::setCoord(Vector2D<K> const& u, L nZ) {
                setX(u.getX());
                setY(u.getY());
                setZ(nZ);
            }
            ...
            template <class T>
            template <class K, class L, class N>
            constexpr void Vector3D<T>::setRGB(K r, L g, N b) {
                setR(r);
                setG(g);
                setB(b);
            }
            ...
            template <class T>
            template <class K>
            constexpr Vector3D<T>& Vector3D<T>::operator +=(K k) {
            ...
            template <class T>
            template <class K>
            constexpr Vector3D<std::common_type_t<T, K>> Vector3D<T>::operator +(K k) const {
            ...
            inline Vector3D<std::common_type_t<T, K>> pow(Vector3D<T> const& u, K k) {
