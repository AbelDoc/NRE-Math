    ...
    namespace NRE {
        namespace Math {
            ...
            constexpr Vector2D<T>::Vector2D(K nX, L nY) : x(static_cast <T> (nX)), y(static_cast <T> (nY)) {
            }

            template <class T>
            template <class K>
            constexpr Vector2D<T>::Vector2D(K value) : Vector2D(value, value) {
            }
            ...
            template <class T>
            template <class K>
            constexpr void Vector2D<T>::setX(K nX) {
                x = static_cast <T> (nX);
            }

            template <class T>
            template <class K>
            constexpr void Vector2D<T>::setY(K nY) {
                y = static_cast <T> (nY);
            }

            template <class T>
            template <class K>
            constexpr void Vector2D<T>::setW(K w) {
                setX(w);
            }

            template <class T>
            template <class K>
            constexpr void Vector2D<T>::setH(K h) {
                setY(h);
            }

            template <class T>
            template <class K, class L>
            constexpr void Vector2D<T>::setCoord(K nX, L nY) {
                setX(nX);
                setY(nY);
            }
            ...
            template <class T>
            template <class K, class L>
            constexpr void Vector2D<T>::setSize(K w, L h) {
                setX(w);
                setY(h);
            }
            ...
            template <class T>
            template <class K>
            constexpr Vector2D<T>& Vector2D<T>::operator +=(K k) {
            ...
            template <class T>
            template <class K>
            constexpr Vector2D<std::common_type_t<T, K>> Vector2D<T>::operator +(K k) const {
