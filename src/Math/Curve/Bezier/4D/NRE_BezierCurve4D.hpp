    ...
    namespace NRE {
        ...
        namespace Math {
             ...
             */
            class BezierCurve4D : public Core::Stringable<BezierCurve4D> {
                private:    //Fields
                    Core::Vector<Point4D<float>> controls;   /**< The curve's control points */
                ...
                public:    // Methods
                    //## Constructor ##//
                         ...
                         */
                        BezierCurve4D(Core::Vector<Point4D<float>> && c) : controls(c) {
                        }
